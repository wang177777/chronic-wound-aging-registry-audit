...
EXPECTED_HASHES = {
    "locked_master": "2afb2717cbd87c25a1d36589fbe11f6fcf0acc31376fea13f8ef2a45d65301aa",
...
CROSS_SCALE_QC_LABEL = (
    ...
    "NOT_PRESPECIFIED_FORMAL_RELIABILITY"
)
COREVEN_DOMAINS = [
    "healing",
    "pain",
...
def build_corrected_reliability_outputs(
    ...
    The 12 newly included records were confirmed in a governed cross-scale
    workflow. Their 309/366 agreement is a workflow-QC result and is not
    the prespecified 120-record inter-rater reliability estimate. The prespecified
    historical reliability functions therefore receive only the protected
    1,206-record rows. Reporter and unit-of-analysis results remain explicitly
    ...
    long_rows.append(
        result_row(
            ...
            "WORKFLOW_QC",
            "HUMAN_CONFIRMED_CROSS_SCALE_ROWS",
            "FIELD_OR_DOMAIN",
...
No field above has been completed by Codex.
"""
    forms = {
...
def run(
    ...
    output_root = (
        ...
        else project_root / "outputs/step_13_age_confirmed_20260730"
    )
    ...
    reports_dir = (
        ...
        else project_root / "reports/step_13_age_confirmed_20260730"
    )
...
"""
    ...
    print("AGE_CONFIRMED_STEP13_ANALYSIS_COMPLETED")
